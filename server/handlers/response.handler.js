...
const resWithPack = (res, statusCode, pack) =>
...
const badRequest = (res, message = "Bad Request") =>
  resWithPack(res, 400, { message });
const unauthorize = (res, message = "Unauthorized") =>
  resWithPack(res, 401, { message });
const forbidden = (res, message = "Forbidden") =>
  resWithPack(res, 403, { message });
const notFound = (res, message = "Resource not found") =>
  resWithPack(res, 404, { message });
const conflict = (res, message = "Conflict") =>
  resWithPack(res, 409, { message });

// 5xx
const error = (res, message) =>
  resWithPack(res, 500, { message: message ?? "Oops! Something wrong!" });
